...
namespace Assets.Scripts.Roguelike {
	...
	/// エネミーの操作挙動
	/// </summary>
	public class Enemy : StageObjectBase {
		[SerializeField]
		...
		public Vector2Int m_ArrayPos;  //このオブジェクト配列内位置
		...
		public bool m_InputReturnWaitFlag = false;
		...
		private void Attack(Player1 player1) {
			this.transform.Find("Damage").GetComponent<AudioSource>().Play();
			player1.Damage();
			this.enabled = false;
		}
